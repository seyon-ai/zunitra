...
(function () {
  ...
  // ── KEYS ────────────────────────────────────────────────────
  const GROQ_KEY    = "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";
  ...
  async function groq(messages, maxTokens) {
    const res = await fetch(GROQ_URL, {
      ...
      body:JSON.stringify({ model:GROQ_MODEL, temperature:0.72, max_tokens:maxTokens||500, messages })
    });
